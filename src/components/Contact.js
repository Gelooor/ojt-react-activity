...
export default function Contact() {
  ...
  return (
    <section
      id='contact'
      className='flex flex-col gap-10 text-gray-500 py-28 font-poppins text-xs sm:gap-5'
    >
      <div>
        <HeaderStyle color={"gray"} text={"Contact Us"} />
        <HeaderStyle color={"gold"} text={"Make an Appointment"} />
      </div>
